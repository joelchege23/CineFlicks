...
class Movie(db.Model):
    ...
    # ratings = db.relationship('UserMovieRating', backref='movie_ratings' , lazy=True)
    # genre_preferences = db.relationship('UserGenrePreference', backref='movie_genre', lazy=True)
